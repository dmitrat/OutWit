...
{
	public class SettingsValueLanguage : SettingsValueBase<string>
	{
        public SettingsValueLanguage(SettingsElementBase defaultElement, SettingsElementBase userElement) :
