...
{
	public class SettingsValueString : SettingsValueBase<string>
	{
		public SettingsValueString(SettingsElementBase defaultElement, SettingsElementBase userElement) : 
