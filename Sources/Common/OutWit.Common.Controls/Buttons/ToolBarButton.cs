...
namespace OutWit.Common.Controls.Buttons
{
    public class ToolBarButton : Button
    {
        ...
        public static readonly DependencyProperty KindProperty = BindingUtils.Register<ToolBarButton, PackIconKind?>(nameof(Kind), OnKindChanged);

        public static readonly DependencyProperty IconHeightProperty = BindingUtils.Register<ToolBarButton, double>(nameof(IconHeight));

        public static readonly DependencyProperty IconWidthProperty = BindingUtils.Register<ToolBarButton, double>(nameof(IconWidth));

        public static readonly DependencyProperty ToolTipKeyProperty = BindingUtils.Register<ToolBarButton, string>(nameof(ToolTipKey), OnToolTipTextChanged);

        public static readonly DependencyProperty TextConverterProperty = BindingUtils.Register<ToolBarButton, StringToResourceConverterBase>(nameof(TextConverter), OnTextConverterChanged);
